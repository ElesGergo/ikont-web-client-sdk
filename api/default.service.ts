...
export class DefaultService {
    ...
    if (typeof value === 'object') {
      if (Array.isArray(value)) {
        ...
        if (key != null) {
          ...
          throw Error(
            'key may not be null if value is Date'
          );
        }
      } else {
  ...
  public appControllerGetHello(
    ...
    let localVarHttpHeaderAcceptSelected:
      | string
      | undefined = options && options.httpHeaderAccept;
  ...
  public authControllerLoginUser(
    ...
    if (body === null || body === undefined) {
      throw new Error(
        'Required parameter body was null or undefined when calling authControllerLoginUser.'
      );
    }
  ...
  public clientManagementControllerFindOne(
    ...
    return this.httpClient.get<string>(
      `${
        this.configuration.basePath
      }/client-management/${encodeURIComponent(
        String(id)
      )}`,
      {
        context: localVarHttpContext,
