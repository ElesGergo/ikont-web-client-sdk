...
export class LocationService {
  ...
  public locationControllerGetAddressSuggestion(
    ...
    if (addressSuggestionDto === null || addressSuggestionDto === undefined) {
      throw new Error(
        'Required parameter addressSuggestionDto was null or undefined when calling locationControllerGetAddressSuggestion.'
      );
    }
